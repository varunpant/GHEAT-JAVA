...
public class QuadTreeTest extends TestCase {
    ...
    public void testGetKeys() {
        PointLatLng[] keys = getTree().getKeys();
        Arrays.sort(keys);
    ...
    public void testSearchIntersects() {
        QuadTree qt = getTree();
        PointLatLng[] points = qt.searchIntersect(4, 0, 51, 98);
        Arrays.sort(points);
        ...
        PointLatLng[] points2 = qt.searchIntersect(5, 0, 50, 96);
        Arrays.sort(points2);
    ...
    public void testSearchWithin() {
        QuadTree qt = getTree();
        PointLatLng[] points = qt.searchWithin(4, -1, 51, 98);
        Arrays.sort(points);
        String keyString = Arrays.asList(points).toString();
        String expected = "[(5.0, 20.0), (12.0, 0.0), (47.0, 96.0), (50.0, 32.0), (50.0, 50.0)]";
        assertEquals("Sorted keys should be " + expected, expected, keyString);
